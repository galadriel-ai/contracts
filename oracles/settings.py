...
FILESYSTEM_PATH = os.getenv("FILESYSTEM_PATH", "assets")
OBJECTSTORE_ADDRESS = os.getenv("OBJECTSTORE_ADDRESS", "t2av2yjdynb34c3az7nvpenwavwd7kob6e26jaiby")
OBJECTSTORE_PRIVATE_KEY = os.getenv("OBJECTSTORE_PRIVATE_KEY")
OBJECTSTORE_NETWORK = os.getenv("OBJECTSTORE_NETWORK", "localnet")