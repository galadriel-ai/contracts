...
async def execute(langchain_repository: LangchainKnowledgeBaseRepository, chat: Chat) -> Tuple[Optional[GroqChatCompletion], int, dict[str, Union[str, List[dict[str, str]]]]]:
